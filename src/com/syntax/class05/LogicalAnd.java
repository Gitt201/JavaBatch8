...
public class LogicalAnd {
	...
	public static void main(String[] args) {
		...
		/*
		 * delcare a number if number is larger than 1 AND smaller than 10 --> SMALL if
		 * number us larger than 10 but smaller than 100 --> MEDIUM if number is larger
		 * than 100 but smaller than 1000 --> Large
		 */
